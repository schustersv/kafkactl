...
func newDeleteUserCmd() *cobra.Command {
	...
	var cmdDeleteUser = &cobra.Command{
		...
		ValidArgsFunction: user.CompleteUserNames,
	}

	cmdDeleteUser.Flags().StringVarP(&flags.ScramMechanism, "mechanism", "m", "SCRAM-SHA-512", "scram mechanism (SCRAM-SHA-256, SCRAM-SHA-512)")
